local Translations = {
    error = {
        ...
        duplicate_license           = '[RSGCORE] - Rockstarライセンスが重複しています',
        no_valid_license            = '[RSGCORE] - 有効なRockstarライセンスが見つかりません',
        not_whitelisted             = '[RSGCORE] - あなたはホワイトリストに登録されていません',
        ...
        connecting_database_error   = '[RSGCORE] - サーバーへの接続中にデータベースエラーが発生しました(SQLサーバの稼働を確認してください)',
        connecting_database_timeout = '[RSGCORE] - データベースへの接続がタイムアウトしました(SQLサーバーの稼働を確認してください)',
    },
    success = {
