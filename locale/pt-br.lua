local Translations = {
    error = {
        ...
        job_not_exist               = 'Emprego não existe',
        gang_not_exist              = 'Gangue não existe',
    ...
    success = {
        ...
        job_set = 'Emprego atribuído com sucesso',
        gang_set = 'Gangue atribuído com sucesso',
    },
    info = {
    ...
    command = {
        ...
        addpermission = {
            help = 'Dá permissões ao jogador (Só Deus)',
            params = {
                id = { name = 'id', help = 'ID do jogador' },
                permission = { name = 'permissão', help = 'Ní­vel de permissão' },
            },
        },
        removepermission = {
        ...
        car = {
            help = 'Criar Veí­culo (somente administrador)',
            params = {
                model = { name = 'modelo', help = 'Modelo do veí­culo' },
            },
        },
        dv = { help = 'Excluir veí­culo (somente administrador)' },
        givemoney = {
